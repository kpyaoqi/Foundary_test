...
contract MyERC20Token is ERC20 {
    ...
    function decreaseAllowance(address spender, uint256 amount)  external returns (bool) {
        require(spender != address(0), "spender is the zero address");
        require(allowance[msg.sender][spender] >= amount, "spender is the zero address");
        allowance[msg.sender][spender]-=amount;
        emit Approval(msg.sender, spender, allowance[msg.sender][spender]);
        return true;
    }
    ...
    function transferFrom(
        ...
        require(recipient != address(0), "Recipient is the zero address");
        require(balanceOf[sender] >= amount, "The authorizer does not have sufficient balance");
        require(allowance[sender][msg.sender] >= amount, "Exceed the authorized limit");
